            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="{{asset('/')}}admin/assets/images/flags/germany.jpg" alt="user-image" class="mr-1"
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="{{asset('/')}}admin/assets/images/flags/russia.jpg" alt="user-image" class="mr-1"
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li @if(request()->segment(1) === 'category') class="mm-active" @endif>
                        <a href="{{route('category')}}" class="waves-effect{{request()->segment(1) === 'category'?' active':null}}">
                            <i class='bx bx-bookmark'></i>
                            <span>Category</span>
                        </a>
                    </li>

                    <li @if(request()->segment(1) === 'sub-category') class="mm-active" @endif>
                        <a href="{{route('sub-category')}}" class="waves-effect{{request()->segment(1) === 'sub-category'?' active':null}}">
                            <i class='bx bx-bookmarks'></i>
                            <span>Sub Category</span>
                        </a>
                    </li>

                    <li @if(request()->segment(1) === 'brand') class="mm-active" @endif>
                        <a href="{{route('brand')}}" class="waves-effect{{request()->segment(1) === 'brand'?' active':null}}">
                            <i class='bx bxs-landmark'></i>
                            <span>Brand</span>
                        </a>
                    </li>

                    <li @if(request()->segment(1) === 'unit') class="mm-active" @endif>
                        <a href="{{route('unit')}}" class="waves-effect{{request()->segment(1) === 'unit'?' active':null}}">
                            <i class='bx bx-cube'></i>
                            <span>Unit</span>
                        </a>
                    </li>

                    <li @if(request()->segment(1) === 'product') class="mm-active" @endif>
                        <a href="{{route('product')}}" class="waves-effect{{request()->segment(1) === 'product'?' active':null}}">
