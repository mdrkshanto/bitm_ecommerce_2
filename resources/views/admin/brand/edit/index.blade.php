            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Update Brand</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between align-middle">
                                ...
                                <a href="{{route('brand')}}" class="btn btn-sm btn-primary shadow-none">Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <form action="{{route('update.brand',['id'=>$brand->id])}}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description"
                                                      class="form-control form-textarea shadow-none">{{$brand->short_description}}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($brand->image)
                                                <div class="image mt-2">
                                                    <img src="{{asset($brand->image)}}" alt="{{$brand->name}}" height="50" width="100">
                                                </div>
                                            @endif
                                            @if($errors->has('image'))
                                        ...
                                        <div class="form-group">
                                            <div class=""><label>Brand Status</label></div>
                                            <div class="row justify-content-between">
                                                <div class="custom-control custom-radio custom-radio-primary mb-3">
                                                    <input type="radio" id="active" name="status" class="custom-control-input" value="1" @checked($brand->status === 1)>
                                                    <label class="custom-control-label" for="active">Active</label>
                                                </div>

                                                <div class="custom-control custom-radio custom-radio-danger mb-3">
                                                    <input type="radio" id="inactive" name="status" class="custom-control-input" value="0" @checked($brand->status !== 1)>
