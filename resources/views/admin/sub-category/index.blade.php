                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header">
                                <div class="row justify-content-between align-middle">
                                    ...
                                    @endif
                                    <a href="{{route('create.sub-category')}}" class="btn btn-sm btn-primary shadow-none">Add
                                        New</a>
                                </div>
                            </div>
                            ...
                            <table id="datatable-buttons"
                                ...
                                @foreach($subCategories as $subCategory)
                                    <tr>
                                        ...
                                        <td class="align-middle{{$subCategory->status==1?' text-success':' text-danger'}}">{{$subCategory->status==1?'Active':'Inactive'}}</td>
                                        <td class="align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{route('edit.sub-category',['slug'=>$subCategory->slug])}}" class="btn btn-primary shadow-none"><i
                                                        class="fa fa-edit"></i></a>

                                            <form action="{{route('delete.sub-category', ['id'=>$subCategory->id])}}" method="post">
                                                @csrf
